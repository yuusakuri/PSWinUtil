...
The 1.x releases between 1.2.2 and 1.6.9 are listed with their notes and tags in [Releases](https://github.com/yuusakuri/PSWinUtil/releases). Their commands were removed in the 2.0.0 rewrite.
