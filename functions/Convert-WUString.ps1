...
param (
    ...
    # If EscapeForPowerShellDoubleQuotation is specified, escape Grave accent (U+0060), Dollar sign (U+0024), Left double quotation mark (U+201C), Right double quotation mark (U+201D), Double low-9 quotation mark (U+201E) for PowerShell doubleQuotation.
