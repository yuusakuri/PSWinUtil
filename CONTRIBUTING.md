...
| `.\dev.ps1 test all` | Builds the module and runs unit, integration, and contract tests without `Network` tests. |
| `.\dev.ps1 test-network-integration` | Builds the module and runs opt-in integration tests against network services. |
