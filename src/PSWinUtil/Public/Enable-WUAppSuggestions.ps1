function Enable-WUAppSuggestions {
    <#
    .SYNOPSIS
    Enables application suggestions.

    .DESCRIPTION
    Applies the Enable option for application suggestions. Registry changes are delegated to the registry property commands.
