Describe 'Process PATH integration' {
    ...
    It 'adds a path without changing existing items' {
        Add-WUPathEnvironmentVariable -Path $script:TestPath -Scope Process
    ...
    It 'does not add a normalized duplicate' {
        Add-WUPathEnvironmentVariable -Path $script:TestPath -Scope Process
        Add-WUPathEnvironmentVariable -Path ($script:TestPath.ToLowerInvariant() + '\') -Scope Process
    ...
    It 'removes a path by its normalized value' {
        ...
        Remove-WUPathEnvironmentVariable -Path ($script:TestPath + '\') -Scope Process
